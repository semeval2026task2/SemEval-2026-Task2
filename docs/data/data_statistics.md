...
<table style="border-collapse:collapse;width:100%;border:1px solid #ccc;font-size:14px;">
  ...
  <tbody>
    <tr>
      <th style="padding:6px 8px;border:1px solid #ccc;text-align:left;">count</th>
      <td style="padding:6px 8px;border:1px solid #ccc;">2,764.00</td>
      <td style="padding:6px 8px;border:1px solid #ccc;">1,331.00</td>
      <td style="padding:6px 8px;border:1px solid #ccc;">1,433.00</td>
      <td style="padding:6px 8px;border:1px solid #ccc;">2,764.00</td>
      <td style="padding:6px 8px;border:1px solid #ccc;">1,331.00</td>
      <td style="padding:6px 8px;border:1px solid #ccc;">1,433.00</td>
    </tr>
    <tr>
      <th style="padding:6px 8px;border:1px solid #ccc;text-align:left;">mean</th>
      <td style="padding:6px 8px;border:1px solid #ccc;">58.66</td>
      <td style="padding:6px 8px;border:1px solid #ccc;">40.27</td>
      <td style="padding:6px 8px;border:1px solid #ccc;">42.03</td>
      <td style="padding:6px 8px;border:1px solid #ccc;">32.91</td>
      <td style="padding:6px 8px;border:1px solid #ccc;">58.76</td>
      <td style="padding:6px 8px;border:1px solid #ccc;">8.90</td>
    </tr>
    <tr>
      <th style="padding:6px 8px;border:1px solid #ccc;text-align:left;">std</th>
      <td style="padding:6px 8px;border:1px solid #ccc;">61.70</td>
      <td style="padding:6px 8px;border:1px solid #ccc;">52.23</td>
      <td style="padding:6px 8px;border:1px solid #ccc;">54.89</td>
      <td style="padding:6px 8px;border:1px solid #ccc;">31.35</td>
      <td style="padding:6px 8px;border:1px solid #ccc;">27.36</td>
      <td style="padding:6px 8px;border:1px solid #ccc;">1.79</td>
    </tr>
    <tr>
      <th style="padding:6px 8px;border:1px solid #ccc;text-align:left;">min</th>
      <td style="padding:6px 8px;border:1px solid #ccc;">2.00</td>
      <td style="padding:6px 8px;border:1px solid #ccc;">1.00</td>
      <td style="padding:6px 8px;border:1px solid #ccc;">1.00</td>
      <td style="padding:6px 8px;border:1px solid #ccc;">5.00</td>
      <td style="padding:6px 8px;border:1px solid #ccc;">9.00</td>
    ...
    <tr>
      <th style="padding:6px 8px;border:1px solid #ccc;text-align:left;">25%</th>
      <td style="padding:6px 8px;border:1px solid #ccc;">16.00</td>
      <td style="padding:6px 8px;border:1px solid #ccc;">9.00</td>
      <td style="padding:6px 8px;border:1px solid #ccc;">9.00</td>
      <td style="padding:6px 8px;border:1px solid #ccc;">9.00</td>
      <td style="padding:6px 8px;border:1px solid #ccc;">47.00</td>
      <td style="padding:6px 8px;border:1px solid #ccc;">9.00</td>
    </tr>
    <tr>
      <th style="padding:6px 8px;border:1px solid #ccc;text-align:left;">50%</th>
      <td style="padding:6px 8px;border:1px solid #ccc;">31.00</td>
      <td style="padding:6px 8px;border:1px solid #ccc;">14.00</td>
      <td style="padding:6px 8px;border:1px solid #ccc;">16.00</td>
      <td style="padding:6px 8px;border:1px solid #ccc;">11.00</td>
      <td style="padding:6px 8px;border:1px solid #ccc;">52.00</td>
      <td style="padding:6px 8px;border:1px solid #ccc;">9.00</td>
    </tr>
    <tr>
      <th style="padding:6px 8px;border:1px solid #ccc;text-align:left;">75%</th>
      <td style="padding:6px 8px;border:1px solid #ccc;">97.00</td>
      <td style="padding:6px 8px;border:1px solid #ccc;">63.00</td>
      <td style="padding:6px 8px;border:1px solid #ccc;">61.00</td>
      <td style="padding:6px 8px;border:1px solid #ccc;">52.00</td>
      <td style="padding:6px 8px;border:1px solid #ccc;">60.00</td>
      <td style="padding:6px 8px;border:1px solid #ccc;">9.00</td>
    </tr>
    <tr>
      <th style="padding:6px 8px;border:1px solid #ccc;text-align:left;">max</th>
      <td style="padding:6px 8px;border:1px solid #ccc;">206.00</td>
      <td style="padding:6px 8px;border:1px solid #ccc;">168.00</td>
      <td style="padding:6px 8px;border:1px solid #ccc;">177.00</td>
      <td style="padding:6px 8px;border:1px solid #ccc;">225.00</td>
      <td style="padding:6px 8px;border:1px solid #ccc;">225.00</td>
      <td style="padding:6px 8px;border:1px solid #ccc;">42.00</td>
    </tr>
  </tbody>
