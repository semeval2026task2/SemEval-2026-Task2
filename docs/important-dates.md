...
- **January 5 – January 28 2026**: Evaluation Phase (System Submissions open with format checker in place for test set; scores released along with leaderboard)
- **January 24 – February 1 2026**: Mandatory Participant Survey (Must include system summary & one volunteer reviewer)
- ~~**January 26 2026**~~ **January 28 2026**: Official System Submission Deadline
- **February 7 2026**: Scores and Leaderboard Release (Gold labels released shortly after)
